...
counts = (
    x3.groupby("administrative_area_level_2")
    .size()
...
fig = px.choropleth(
    ...
    title="COVID-19 Datapoints per State (Level 3 — County)",
    labels={"datapoints": "Datapoints"},
)
fig.update_layout(margin={"r": 0, "t": 50, "l": 0, "b": 0})

out_path = os.path.join(os.path.dirname(__file__), "..", "outputs", "us_map.html")
